...
const StatsCards: React.FC = () => {
  ...
  const { overviewdata, isLoading: isOverviewLoading, isError: isOverviewError } = useGetOverviewStatsQuery(undefined);
  console.log("Overview Stats", data)
  ...
  const stats = [
    {
      title: 'Total Leads',
      value: analyticsData.total_leads.value.toString(),
      subtitle: analyticsData.total_leads.sub_text,
      icon: <Users size={24} strokeWidth={2} />,
      subtitleColor: analyticsData.total_leads.value > 0 ? 'text-green-600' : 'text-gray-600'
    },
    {
      title: 'Listed Properties',
      value: analyticsData.active_properties.value.toString(),
      subtitle: analyticsData.active_properties.sub_text,
      icon: <Building2 size={24} strokeWidth={2} />,
      subtitleColor: analyticsData.active_properties.value > 0 ? 'text-green-600' : 'text-gray-600'
    },
    {
      title: 'Conversion Rate',
      value: analyticsData.conversion_rate.value,
      subtitle: analyticsData.conversion_rate.sub_text,
