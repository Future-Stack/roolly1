...
const StatsCards: React.FC = () => {
  ...
  const { data: overviewData, isLoading: isOverviewLoading, isError: isOverviewError } = useGetOverviewStatsQuery(undefined);
  // console.log('Analytics Data:', data);
  console.log('Overview Data:', overviewData);

  const overviewData = overviewData as AnalyticsData;
  ...
  const stats = [
    {
      ...
      subtitle: overviewData.lead_stats.sub_text,
      icon: <Users size={24} strokeWidth={2} />,
      subtitleColor: overviewData.lead_stats.value > 0 ? 'text-green-600' : 'text-gray-600'
    },
    {
    ...
    },
    {
      ...
      subtitleColor: overviewData.conversion_rate.value !== "0%" ? 'text-green-600' : 'text-gray-600'
    },
    {
      title: 'Total Views',
      value: overviewData.total_views.value.toString(),
      subtitle: overviewData.total_views.sub_text,
      icon: <Eye size={24} strokeWidth={2} />,
      subtitleColor: overviewData.total_views.value > 0 ? 'text-green-600' : 'text-gray-600'
    }
  ];
