...
import { useGetPropertyStatusCountsQuery } from '@/redux/features/vendor/overview';
...
const LeadPropertyStats: React.FC = () => {
    const { data: propertyData, isLoading: propertyLoading, isError: propertyError } = useGetPropertyStatusCountsQuery();
