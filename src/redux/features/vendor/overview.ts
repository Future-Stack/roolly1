...
export interface RecentListedProperty {
...
export type RecentListedPropertiesResponse = RecentListedProperty[];
...
const overviewApi = baseApi.injectEndpoints({
    endpoints: (builder) => ({
        ...
        getRecentListedProperties: builder.query<RecentListedPropertiesResponse, void>({
            query: () => ({
                url: '/vendors/recent-listed-properties/',
                method: 'GET',
            }),
            providesTags: ['Vendors_Profile']
        }),
...
export const {
    ...
    useGetRecentListedPropertiesQuery
} = overviewApi;