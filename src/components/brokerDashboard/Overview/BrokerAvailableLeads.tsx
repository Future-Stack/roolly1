                    ...
                    <div key={lead.id} className="bg-white rounded-xl border border-gray-200 p-5 relative">
                        ...
                        <div className="flex items-start justify-between mb-4">
                            <div className="flex items-center gap-3">
                                ...
                                <span className={`px-3 py-1 rounded text-[12px] font-semibold ${lead.status === 'Green' ? 'bg-green-500 text-white' : 'bg-[#EAB308] text-white'
                                    }`}>
                                    {lead.status}
                                </span>
                                <span className={`px-3 py-1 rounded-full text-[12px] font-semibold ${lead.secondaryStatus === 'NEW' ? 'bg-[#EA580C] text-white' : 'bg-blue-600 text-white'
                                    }`}>
